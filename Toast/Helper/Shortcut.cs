...
namespace DesktopToast.Helper
{
    ...
    internal class Shortcut
    {
            ...
            Guid activatorId)
        {
            ...
            using (ShellLink shellLink = new ShellLink(shortcutPath))
            {
        ...
        private static ShellLink.SW ConvertToWindowStyle(ShortcutWindowState windowState)
        {
            switch (windowState)
            {
                case ShortcutWindowState.Maximized:
                    return ShellLink.SW.SHOWMAXIMIZED;
                case ShortcutWindowState.Minimized:
                    return ShellLink.SW.SHOWMINNOACTIVE;
                default:
                    return ShellLink.SW.SHOWNORMAL;
            }
        }
