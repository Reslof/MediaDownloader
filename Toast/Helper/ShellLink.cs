...
namespace DesktopToast.Helper
{
    ...
    internal class ShellLink : IDisposable
    {
        ...
        private struct PropertyKey
        {
            ...
            private readonly int propertyId; // Property identifier (PID)
        ...
        private IPersistFile PersistFile
        {
            get
            {
                IPersistFile pf = shellLink as IPersistFile;
                if (pf == null)
                {
        ...
        private IPropertyStore PropertyStore
        {
            get
            {
                IPropertyStore ps = shellLink as IPropertyStore;
                if (ps == null)
                {
        ...
        internal string TargetPath
        {
            get
            {
                ...
                VerifySucceeded(shellLink.GetPath(sb, sb.Capacity, ref data, SLGP.UNCPRIORITY));
            ...
            set
            {
                ...
                VerifySucceeded(shellLink.SetPath(value));
            }
        }
        ...
        internal string Arguments
        {
            ...
            set => VerifySucceeded(shellLink.SetArguments(value));
        }
        ...
        internal string Description
        {
            get
            {
                ...
                VerifySucceeded(shellLink.GetDescription(sb, sb.Capacity));
            ...
            set
            {
                ...
                VerifySucceeded(shellLink.SetDescription(value));
            }
        }
        ...
        internal string WorkingDirectory
        {
            ...
            {
                StringBuilder sb = new StringBuilder(MAX_PATH - 1);
                VerifySucceeded(shellLink.GetWorkingDirectory(sb, sb.Capacity));
            ...
            set
            {
                ...
                VerifySucceeded(shellLink.SetWorkingDirectory(value));
            }
        }
        ...
        internal SW WindowStyle
        {
            get
            {
                VerifySucceeded(shellLink.GetShowCmd(out SW showCmd));

                return showCmd;
            }
            set => VerifySucceeded(shellLink.SetShowCmd(value));
        }
        ...
        internal string IconPath
        {
            ...
            {
                StringBuilder sb = new StringBuilder(MAX_PATH - 1);
                VerifySucceeded(shellLink.GetIconLocation(sb, sb.Capacity, out int index));
            ...
            set
            {
                ...
                VerifySucceeded(shellLink.SetIconLocation(value, IconIndex));
            }
        }
        ...
        internal int IconIndex
        {
            ...
            set
            {
                ...
                VerifySucceeded(shellLink.SetIconLocation(IconPath, index));
            }
        }
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern void PropVariantClear([In, Out] ShellLink.PropVariant pvar); // Or ref
    }
}